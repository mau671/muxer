...
func TestBuildCommand(t *testing.T) {
	...
	expected := []string{
		...
		"--language", "1:es-419", "--default-track", "1:yes", "--track-name", "1:Spanish (Latin America)",
		"--language", "2:es-419", "--default-track", "2:yes", "--forced-track", "2:yes", "--track-name", "2:Spanish (Latin America) [Forced]",
		"--audio-tracks", "1",
		"--subtitle-tracks", "2",
		"--title", "",
